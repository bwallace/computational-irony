...
db_path = "/Users/bwallace/dev/computational-irony/annotation/ironator/ironator/ironator.db"
...
def _insert_past_user_comment(user_comment):
    ...
    cursor.execute(
        '''INSERT INTO ironate_past_user_comment 
